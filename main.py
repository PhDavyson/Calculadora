...
from PyQt5.QtWidgets import QGridLayout, QPushButton, QLineEdit, QSizePolicy

class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle(f'Calculadora')
        ...
        self.display.setStyleSheet(
            '* {background: gray; color: #000; font-size: 30px;}'
        )
        ...
        self.add_btn(
            ...
            'background: #f15908; color: #030303; font-weight: 700;'
        )
        ...
        self.add_btn(
            ...
            'background: #ef0707; color: #030303; font-weight: 700;',
        )
        ...
        self.add_btn(QPushButton('00'), 4, 0, 1, 1)
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.eval_igual,
            'background: #3e1fcf; color: #030303; font-weight: 2000;',
        )
    ...
    def eval_igual(self):
        try:
            ...
            self.display.setText(f'Erro! Conta inválida.')
